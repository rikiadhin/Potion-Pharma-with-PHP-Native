...
$rowstoko = queryObat("SELECT * FROM tb_toko");
                                                  ...
                                                  <div class="card-body table-border-style">
                                                       <div class="table-responsive">
                                                            <table border="1" cellpadding=10 cellspacing=0>
                                                                 ...
                                                                 <tbody>
                                                                      <?php foreach ($rowstoko as $rowobat) : ?>
                                                                           <tr>
                                                                                <td class="table-info">
                                                                                     <?php echo $rowobat["id_toko"] ?>
                                                                                </td>
                                                                                <td class="table-success">
                                                                                     <?php echo $rowobat["namatoko"] ?>
                                                                                </td>
                                                                                <td class="table-warning">
                                                                                     <?php echo $rowobat["alamat"] ?>
                                                                                </td>
                                                                                <td class="table-warning">
                                                                                     <?php echo $rowobat["pemilik"] ?>
                                                                                </td>
                                                                                <td class="table-warning">
                                                                                     <?php echo $rowobat["usernameUser"] ?>
                                                                                </td>
                                                                                <td class="table-primary">
                                                                                     <a href="../obat/ubah_obat.php?id= <?php echo $rowobat["id_toko"] ?>"><button class="btn btn-success">Ubah
                                                                                               Data</button></a>
                                                                                     <a href="../obat/hapus_obat.php?id= <?php echo $rowobat["id_toko"] ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ?')"><button class="btn btn-danger">Hapus
                                                                                               Data</button></a>
                                                                                </td>
                                                                           </tr>
                                                                      <?php endforeach; ?>
