...
$rowsobat = mysqli_query($conn, "SELECT * FROM tb_obat");
$username =   $_SESSION["username"];
$rowspesan = queryObat("SELECT * FROM tb_keranjang WHERE username = '$username'");

if (isset($_POST["add_to_cart"])) {
  // Mendapatkan key yang sesuai dengan item obat yang dipilih
  $_SESSION["id_obat"] = $_POST["id_obat"];
...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="dashboard_pembeli.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Store</strong></div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="col-sm-6 col-lg-4 text-center item mb-4">
          ...
          <form action="" method="post">
            ...
            <img src="images/<?php echo $row["gambar"]; ?>" alt="Image">
            <h3 class="text-dark"><?php echo $row["nama_obat"]; ?></h3>
            <p class="price">Harga : <?php echo $row["harga"]; ?></p>
            <p>
