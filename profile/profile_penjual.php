...
$result1 = mysqli_query($conn, "SELECT * FROM tb_penjual WHERE username = '$nama'");
          ...
          <form action="" method="post">
               <div class="container-fluid">
                    <div class="row">
                         ...
                         <div class="col-md-4">
                              <div class="p-3 py-5">
                                   <div class="d-flex justify-content-between align-items-center experience"><span> </span><span class="btn btn-secondary"> &nbsp;<a style="text-decoration:none; color:white" href="../dashboard_penjual.php">Kembali</a></span></div>

                                   <div class=" d-flex justify-content-between align-items-center experience"><span><b>Profil Toko</b></span><span class=" "> </span></div>

                                   <div class="col-md-12"><label class="labels">Nama Toko</label><input name="id_toko" type="hidden" class="form-control" placeholder="Nama Toko" value="<?php echo $rows2['id_toko']; ?>"></div> <br>

                                   <div class="col-md-12"><label class="labels">Nama Toko</label><input name="namatoko" type="text" class="form-control" placeholder="Nama Toko" value="<?php echo $rows2['namatoko']; ?>"></div> <br>

                                   <div class="col-md-12"><label class="labels">Nama Pemilik</label><input name="pemilik" type="text" class="form-control" placeholder="Nama Pemilik" value="<?php echo $rows2['pemilik']; ?>"></div> <br>

                                   <div class="col-md-12"><label class="labels">Alamat</label><input name="alamat" type="text" class="form-control" placeholder="Alamat" value="<?php echo $rows2['alamat']; ?>"></div>
                              </div>
                         </div>
                    </div>
               </div>
