          ...
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                <li class="active"><a href="dashboard_pembeli.php">Home</a></li>
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li><a href="profile/profile_pembeli.php">Profile</a></li>
                    <li><a href="logout.php" onclick="return confirm('Apakah anda yakin ingin keluar ?')">Log out</a></li>
                  </ul>
                </li>
              </ul>
            </nav>
